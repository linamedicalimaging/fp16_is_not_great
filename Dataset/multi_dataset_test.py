...
class multi_dataset(Dataset):
    def __init__(self, text_tokenizer, test_split='close', max_seq=2048, max_img_size=10, image_num=32, voc_size=32000):
        ...
        if self.test_split == 'diagnosis':
            ...
            self.data_whole_2D = self.data_whole_2D + [{'chestxray_dataset_bn': i} for i in
                                                       range(len(chestxray_dataset_bn))]
            ...
            self.data_whole_2D = self.data_whole_2D + [{'spinexr_dataset_bn': i} for i in
                                                       range(len(spinexr_dataset_bn))]
        ...
        if self.test_split == 'modality':
            ...
            self.data_whole_3D = self.data_whole_3D + [{'radiomodality_dataset': i} for i in
                                                       range(len(radiomodality_dataset))]
        ...
        if self.test_split == 'vqa':
            ...
            pmcvqa_dataset = VQA_Dataset(
                csv_path='/gpfs/home/cs/leijiayu/wuchaoyi/wangyingjie/src/New_Dataset/data_csv/pmcvqa_test.csv')
            ...
            self.data_whole_2D = self.data_whole_2D + [{'casereport_dataset': i} for i in
                                                       range(len(casereport_dataset))]
            print('casereport_dataset loaded')

            vqarad_dataset = VQA_Dataset(
                csv_path='/gpfs/home/cs/leijiayu/wuchaoyi/wangyingjie/src/New_Dataset/data_csv/vqarad_test.csv')
            ...
            slake_dataset = VQA_Dataset(
                csv_path='/gpfs/home/cs/leijiayu/wuchaoyi/wangyingjie/src/New_Dataset/data_csv/slakevqa_test.csv')
            ...
            ## 3D
            radiovqa_dataset = RadioVQA_Dataset(
                csv_path='/gpfs/home/cs/leijiayu/wuchaoyi/wangyingjie/src/New_Dataset/data_csv/radiology_vqa_test.csv')
        ...
        if self.test_split == 'caption':
            ...
            chestxray_caption_dataset = ChestXray_Dataset(
                csv_path='/home/lina/RadFM_fine-tuning/Dataset/INbreast/CSV_PNG/推理使用的csv文件/test_split_radfm.csv',
                # Adjust to Lina's file path
                prompt_json_file='/home/lina/RadFM_fine-tuning/Dataset/INbreast/prompt_breast.json')  # Adjust to Lina's file path
            self.dataset_reflect['INbreast_dataset'] = chestxray_caption_dataset
            self.data_whole_2D = self.data_whole_2D + [{'INbreast_dataset': i} for i in
                                                       range(len(chestxray_caption_dataset))]
            print('INbreast_dataset loaded')
            ...
            #                                             )     # Lina注释掉的
            # self.dataset_reflect['radiocaption_dataset'] = radiocaption_dataset       # Lina注释掉的
            # self.data_whole_3D = self.data_whole_3D +  [{'radiocaption_dataset':i} for i in range(len(radiocaption_dataset))]     # Lina注释掉的
            # print('radiocaption_dataset loaded')      # Lina注释掉的
        ...
        if self.test_split == 'feature':
            ...
            self.data_whole_3D = self.data_whole_3D + [{'radiofeatures_dataset': i} for i in
                                                       range(len(radiofeatures_dataset))]
