...
class MultiLLaMAForCausalLM(nn.Module):
    def __init__(self):  
        ...
        self.lang_model = LlamaForCausalLM.from_pretrained("/hdd/checkpoints_lina/hf/models--meta-llama--Llama-2-13b-hf/snapshots/5c31dfb671ce7cfe2d7bb7c04375e44c55e815b1", local_files_only=True, device_map="auto")
