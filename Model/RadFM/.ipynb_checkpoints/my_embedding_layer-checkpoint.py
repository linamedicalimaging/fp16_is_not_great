...
class MyEmbedding(nn.Module):
    def __init__(self, num_embeddings=32000, embedding_dim=5120, perceiver_num=32,vis_dim = 768, patch_size=32, frame_patch_size = 4 ,seg_channel = 256):
        ...
        self.bert_tokenizer = AutoTokenizer.from_pretrained("/hdd/checkpoints_lina/hf/models--xmcmic--Med-KEBERT/snapshots/3e877eb9119224b81eaffe13839cd93f073cfc37", local_files_only=True)
        self.bert_model = BertModel(AutoConfig.from_pretrained("/hdd/checkpoints_lina/hf/models--xmcmic--Med-KEBERT/snapshots/3e877eb9119224b81eaffe13839cd93f073cfc37", local_files_only=True, device_map="auto"))        
